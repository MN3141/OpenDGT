...
Trecând la următorul criteriu (facilitatea de depanare a programlor), aceste este încălcat și ne obligă să considerăm alte opțiuni. În ciuda faptului că documentația oficială \cite{atmega_datasheet} specifică un sistem de depanare pe cip (debugWIRE), problema rămâne de interfațarea cu acesta. Plaăcile Arduino nu oferă o soluție iar procurarea unor programatoare pentru acest protocol este dificilă din cauza indisponibilității sau a prețului acestora.
