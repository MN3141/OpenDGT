...
Pentru cel care vrea să își organizeze o partidă de șah acesta are la dispoziția sa o multitudine de opțiuni pe piață, dintre care vom aminti \textit{Digital Game Technology}. Digital Game Technology (DGT pe scurt) este olandeză ce produce ceasuri de șah aprobate de FIDE (Fédération Internationale des Échecs)) \cite{dgt_clock}. Aceste ceasuri pot fi utilizate împreună cu table inteligente de șah sau separt. Mai nou acesta conțin un întreg sistem de calcul ce permit jucătorului să joace meciuri împotriva calculatorului fără a mai fi necesară conectarea la un PC \cite{dgt_computer}. \\
