...
\begin{enumerate}
	...
	\item Pinul 1 este legat la partea centrala a conectorului (Ring).
	\item Pini 2 și 3 sunt legați între ei iar apoi la vărful conectorului jack (Tip).
	\item Pinii 4 și 5 sunt legați între ei iar apoi la partea inferioară a conectorului (Sleeve).
